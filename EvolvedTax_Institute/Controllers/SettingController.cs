...
namespace EvolvedTax_Institute.Controllers
{
            ...
            List<string> dateFormats = new List<string>
    {
        ...
        .FirstOrDefault();
            ...
            model.InstituteEmailTemplate = _evolvedtaxContext.InstituteEmailTemplate.Where(p => p.InstituteID == SessionUser.InstituteId && p.TemplateName == AppConstants.ClientEmailTemplate).Select(p => new InstituteEmailTemplate
            {
            ...
            List<string> dateFormats = new List<string>
    {
        ...
        .FirstOrDefault();
            ...
            var instituteMaster = _evolvedtaxContext.InstituteMasters.FirstOrDefault(es => es.InstId == instituteId);
            model.InstituteEmailTemplate = _evolvedtaxContext.InstituteEmailTemplate.Where(p => p.InstituteID == SessionUser.InstituteId && p.TemplateName == AppConstants.ElectronicAcceptanceEmailTemplate).Select(p => new InstituteEmailTemplate
            {
