...
namespace EvolvedTax_Institute.Controllers
{
    public class UserManagementController : BaseController
    {
        ...
        public IActionResult SendInvitaionLink(UserManagementRequest request)
        {
            ...
            _mailService.SendInvitaionEmail(request.InvitationEmailDetails, URL, instId, "Action Required: You have been invited to signup with EvoForms", instituteName, instId);
