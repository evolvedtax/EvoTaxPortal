...
namespace EvolvedTax_Institute.Areas._1042.Controllers
{
    ...
    public class InstituteController : BaseController
    {
        ...
        public IActionResult W9Entities(int? instituteId)
        {
            ...
            model.InstituteEntitiesResponse = _instituteService.GetEntitiesByInstId(InstId,Convert.ToInt32( AppConstants.FormSubscription_1042));
            return View(model);
        }
        ...
        {
            var response = await _instituteService.DeleteMultipleEntity(selectedValues, RecordStatusEnum.Trash, Convert.ToInt32(AppConstants.FormSubscription_1042));
        ...
        public async Task<IActionResult> DeleteEntity(int id)
        {
            ...
            var response = await _instituteService.DeleteEntity(id, RecordStatusEnum.Trash, Convert.ToInt32(AppConstants.FormSubscription_1042));
            return Json(response);
        }
        ...
        public async Task<IActionResult> AddEntity(InstituteEntityViewModel request, int[] subscriptionId)
        {
            ...
            {
                subscriptionId = new int[] { Convert.ToInt32(AppConstants.FormSubscription_1042) };
            }
