...
{
    [Area("5498")]
    public class Institute5498Controller : BaseController
    {
        ...
        public Institute5498Controller(IInstituteService instituteService, IMailService emailService, IWebHostEnvironment webHostEnvironment,
        ...
        public IActionResult W9Entities(int? instituteId)
        {
            ...
            model.InstituteEntitiesResponse = _instituteService.GetEntitiesByInstId(InstId,Convert.ToInt32( AppConstants.FormSubscription_5498));
            return View(model);
        }
        ...
        {
            var response = await _instituteService.DeleteMultipleEntity(selectedValues, RecordStatusEnum.Trash, Convert.ToInt32(AppConstants.FormSubscription_5498));
        ...
        public async Task<IActionResult> DeleteEntity(int id)
        {
            ...
            var response = await _instituteService.DeleteEntity(id, RecordStatusEnum.Trash, Convert.ToInt32(AppConstants.FormSubscription_5498));
            return Json(response);
        }
        ...
        public async Task<IActionResult> AddEntity(InstituteEntityViewModel request, int[] subscriptionId)
        {
            ...
            {
                subscriptionId = new int[] { Convert.ToInt32(AppConstants.FormSubscription_5498) };
            }
