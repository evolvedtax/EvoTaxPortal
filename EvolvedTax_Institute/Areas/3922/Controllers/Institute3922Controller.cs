...
{
    [Area("3922")]
    public class Institute3922 : BaseController
    {
        ...
        public Institute3922(IInstituteService instituteService, IMailService emailService, IWebHostEnvironment webHostEnvironment,
        ...
        public IActionResult W9Entities(int? instituteId)
        {
            ...
            model.InstituteEntitiesResponse = _instituteService.GetEntitiesByInstId(InstId,Convert.ToInt32( AppConstants.FormSubscription_3922));
            return View(model);
        }
        ...
        {
            var response = await _instituteService.DeleteMultipleEntity(selectedValues, RecordStatusEnum.Trash, Convert.ToInt32(AppConstants.FormSubscription_3922));
        ...
        public async Task<IActionResult> DeleteEntity(int id)
        {
            ...
            var response = await _instituteService.DeleteEntity(id, RecordStatusEnum.Trash, Convert.ToInt32(AppConstants.FormSubscription_3922));
            return Json(response);
        }
        ...
        public async Task<IActionResult> AddEntity(InstituteEntityViewModel request, int[] subscriptionId)
        {
            ...
            {
                subscriptionId = new int[] { Convert.ToInt32(AppConstants.FormSubscription_3922) };
            }
