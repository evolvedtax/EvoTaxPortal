...
namespace EvolvedTax_Institute.Areas._1098.Controllers
{
    ...
    public class Form1098_T_Controller : BaseController
    {
        ...
        public IActionResult DownloadAll([FromBody] DownloadRequestModel model)
        {
            ...
            string SavePathFolder = Path.Combine(_webHostEnvironment.WebRootPath, AppConstants.Form1042S);
            var zipFilePath = _form1098_T_Service.GenerateAndZipPdfs(ids, SavePathFolder, selectedPage, RootPath);
        ...
        public IActionResult DownloadOneFile([FromBody] DownloadRequestModel model)
        {
            ...
            //    selectedPage.Add("7");
            //}
            var zipFilePath = _form1098_T_Service.DownloadOneFile(ids, SavePathFolder, selectedPage, RootPath);
            string contentType = "application/zip";
