...
{
    [Area("1098")]
    public class Form1098_T_Controller : BaseController
    {
        private readonly IForm1098_T_Service _form1098_T_Service;
        private readonly IInstituteService _instituteService;
        private readonly ICommonService _commonService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public Form1098_T_Controller(IForm1098_T_Service form1098_T_Service, IWebHostEnvironment webHostEnvironment, ICommonService commonService, IInstituteService instituteService)
        {
            _form1098_T_Service = form1098_T_Service;
        ...
        public IActionResult Index()
        {
            ...
            return View(_form1098_T_Service.GetForm1098TList().Where(p => p.EntityId == EntityId));
        }
        [Route("Form1098_T/uploadClients")]
        [HttpPost]
        public async Task<IActionResult> UploadClients(IFormFile file, int EntityId, string entityName)
        {
            ...
            var response = await _form1098_T_Service.Upload1098_T_Data(file, SessionUser.InstituteId, EntityId, SessionUser.UserId);
        ...
        public IActionResult ChangeEntity(int entityId)
        {
            ...
            var response = _form1098_T_Service.GetForm1098TList().Where(p => p.EntityId == entityId);
        ...
        {
            string TemplatePathFile = Path.Combine(_webHostEnvironment.WebRootPath, "Forms", AppConstants.Form1098TTemplateFileName);
            string SavePathFolder = Path.Combine(_webHostEnvironment.WebRootPath, AppConstants.Form1098T);
            var entityId = HttpContext.Session.GetInt32("EntityId") ?? 0;
            string pdfUrl = _form1098_T_Service.GeneratePdf(Id, TemplatePathFile, SavePathFolder, entityId);
            return Json(pdfUrl);
        }

        [HttpPost]

        [Route("Form1098_T/DownloadAll")]
        public IActionResult DownloadAll([FromBody] DownloadRequestModel model)
        {
            ...
            string SavePathFolder = Path.Combine(_webHostEnvironment.WebRootPath, AppConstants.Form1098T);
            var entityId = HttpContext.Session.GetInt32("EntityId") ?? 0;
            var zipFilePath = _form1098_T_Service.GenerateAndZipPdfs(ids, SavePathFolder, selectedPage, RootPath, entityId);
        ...
        [HttpPost]
        [Route("Form1098_T/DownloadOneFile")]
        public IActionResult DownloadOneFile([FromBody] DownloadRequestModel model)
        {
            ...
            //}
            var entityId = HttpContext.Session.GetInt32("EntityId") ?? 0;
            var zipFilePath = _form1098_T_Service.DownloadOneFile(ids, SavePathFolder, selectedPage, RootPath, entityId);
            string contentType = "application/zip";
        ...
        public async Task<IActionResult> KeepRecord(int id)
        {
            ...
            var response = await _form1098_T_Service.KeepRecord(id);
            return Json(response);
        }
        ...
        public async Task<IActionResult> DeleteRecord(int id)
        {
            ...
            var response = await _form1098_T_Service.DeletePermeant(id);
            return Json(response);
        }
    }
}
