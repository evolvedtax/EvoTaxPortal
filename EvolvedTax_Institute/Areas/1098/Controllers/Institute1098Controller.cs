...
{
    [Area("1098")]
    public class Institute1098Controller : BaseController
    {
        ...
        public Institute1098Controller(IInstituteService instituteService, IMailService emailService, IWebHostEnvironment webHostEnvironment,
        ...
        public IActionResult Entities(int? instituteId)
        {
            ...
            model.InstituteEntitiesResponse = _instituteService.GetEntitiesByInstId(InstId,Convert.ToInt32( AppConstants.FormSubscription_1098));
            return View(model);
        }
        ...
        {
            var response = await _instituteService.DeleteMultipleEntity(selectedValues, RecordStatusEnum.Trash, Convert.ToInt32(AppConstants.FormSubscription_1098));
        ...
        public async Task<IActionResult> DeleteEntity(int id)
        {
            ...
            var response = await _instituteService.DeleteEntity(id, RecordStatusEnum.Trash, Convert.ToInt32(AppConstants.FormSubscription_1098));
            return Json(response);
        }
        ...
        public async Task<IActionResult> AddEntity(InstituteEntityViewModel request, int[] subscriptionId)
        {
            ...
            {
                subscriptionId = new int[] { Convert.ToInt32(AppConstants.FormSubscription_1098) };
            }
