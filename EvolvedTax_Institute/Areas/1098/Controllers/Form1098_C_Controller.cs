...
{
    [Area("1098")]
    public class Form1098_C_Controller : BaseController
    {
        private readonly IForm1098_C_Service _form1098_C_Service;
        private readonly IInstituteService _instituteService;
        private readonly ICommonService _commonService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public Form1098_C_Controller(IForm1098_C_Service form1098_C_Service, IWebHostEnvironment webHostEnvironment, ICommonService commonService, IInstituteService instituteService)
        {
            _form1098_C_Service = form1098_C_Service;
        ...
        public IActionResult Index()
        {
            ...
            return View(_form1098_C_Service.GetForm1098CList().Where(p => p.EntityId == EntityId));
        }
        [Route("Form1098_C/uploadClients")]
        [HttpPost]
        public async Task<IActionResult> UploadClients(IFormFile file, int EntityId, string entityName)
        {
            ...
            var response = await _form1098_C_Service.Upload1098_C_Data(file, SessionUser.InstituteId, EntityId, SessionUser.UserId);
        ...
        public IActionResult ChangeEntity(int entityId)
        {
            ...
            var response = _form1098_C_Service.GetForm1098CList().Where(p => p.EntityId == entityId);
        ...
        [HttpPost]
        [Route("Form1098_C/DownloadOneFile")]
        ...
        public async Task<IActionResult> KeepRecord(int id)
        {
            ...
            var response = await _form1098_C_Service.KeepRecord(id);
            return Json(response);
        }
        ...
        public async Task<IActionResult> DeleteRecord(int id)
        {
            ...
            var response = await _form1098_C_Service.DeletePermeant(id);
            return Json(response);
        }
    }
}
