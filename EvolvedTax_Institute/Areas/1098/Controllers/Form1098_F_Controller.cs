...
{
    [Area("1098")]
    public class Form1098_F_Controller : BaseController
    {
        private readonly IForm1098_F_Service _form1098_F_Service;
        private readonly IInstituteService _instituteService;
        private readonly ICommonService _commonService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public Form1098_F_Controller(IForm1098_F_Service form1098_F_Service, IWebHostEnvironment webHostEnvironment, ICommonService commonService, IInstituteService instituteService)
        {
            _form1098_F_Service = form1098_F_Service;
        ...
        public IActionResult Index()
        {
            ...
            return View(_form1098_F_Service.GetForm1098FList().Where(p => p.EntityId == EntityId));
        }
        [Route("Form1098_F/uploadClients")]
        [HttpPost]
        public async Task<IActionResult> UploadClients(IFormFile file, int EntityId, string entityName)
        {
            ...
            var response = await _form1098_F_Service.Upload1098_F_Data(file, SessionUser.InstituteId, EntityId, SessionUser.UserId);
        ...
        public IActionResult ChangeEntity(int entityId)
        {
            ...
            var response = _form1098_F_Service.GetForm1098FList().Where(p => p.EntityId == entityId);
        ...
        [HttpPost]
        [Route("Form1098_F/DownloadOneFile")]
        ...
        public async Task<IActionResult> KeepRecord(int id)
        {
            ...
            var response = await _form1098_F_Service.KeepRecord(id);
            return Json(response);
        }
        ...
        public async Task<IActionResult> DeleteRecord(int id)
        {
            ...
            var response = await _form1098_F_Service.DeletePermeant(id);
            return Json(response);
        }
    }
}
