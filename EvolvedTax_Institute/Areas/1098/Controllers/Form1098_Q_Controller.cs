...
{
    [Area("1098")]
    public class Form1098_Q_Controller : BaseController
    {
        private readonly IForm1098_Q_Service _form1098_Q_Service;
        private readonly IInstituteService _instituteService;
        private readonly ICommonService _commonService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public Form1098_Q_Controller(IForm1098_Q_Service form1098_Q_Service, IWebHostEnvironment webHostEnvironment, ICommonService commonService, IInstituteService instituteService)
        {
            _form1098_Q_Service = form1098_Q_Service;
        ...
        public IActionResult Index()
        {
            ...
            return View(_form1098_Q_Service.GetForm1098QList().Where(p => p.EntityId == EntityId));
        }
        [Route("Form1098_Q/uploadClients")]
        [HttpPost]
        public async Task<IActionResult> UploadClients(IFormFile file, int EntityId, string entityName)
        {
            ...
            var response = await _form1098_Q_Service.Upload1098_Q_Data(file, SessionUser.InstituteId, EntityId, SessionUser.UserId);
        ...
        public IActionResult ChangeEntity(int entityId)
        {
            ...
            var response = _form1098_Q_Service.GetForm1098QList().Where(p => p.EntityId == entityId);
        ...
        public IActionResult DownlodPdf(int Id)
        {
            ...
            var entityId = HttpContext.Session.GetInt32("EntityId") ?? 0;
            string pdfUrl = _form1098_Q_Service.GeneratePdf(Id, TemplatePathFile, SavePathFolder, entityId);
            return Json(pdfUrl);
        }

        [HttpPost]

        [Route("Form1098_Q/DownloadAll")]
        public IActionResult DownloadAll([FromBody] DownloadRequestModel model)
        {
            ...
            string SavePathFolder = Path.Combine(_webHostEnvironment.WebRootPath, AppConstants.Form1098Q);
            var entityId = HttpContext.Session.GetInt32("EntityId") ?? 0;
            var zipFilePath = _form1098_Q_Service.GenerateAndZipPdfs(ids, SavePathFolder, selectedPage, RootPath, entityId);
        ...
        [HttpPost]
        [Route("Form1098_Q/DownloadOneFile")]
        public IActionResult DownloadOneFile([FromBody] DownloadRequestModel model)
        {
            ...
            //}
            var entityId = HttpContext.Session.GetInt32("EntityId") ?? 0;
            var zipFilePath = _form1098_Q_Service.DownloadOneFile(ids, SavePathFolder, selectedPage, RootPath, entityId);
            string contentType = "application/zip";
        ...
        public async Task<IActionResult> KeepRecord(int id)
        {
            ...
            var response = await _form1098_Q_Service.KeepRecord(id);
            return Json(response);
        }
        ...
        public async Task<IActionResult> DeleteRecord(int id)
        {
            ...
            var response = await _form1098_Q_Service.DeletePermeant(id);
            return Json(response);
        }
    }
}
