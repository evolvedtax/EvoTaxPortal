...
{
    public class Form1099_PATR_Controller : BaseController
    {
        private readonly IForm1099_PATR_Service _form1099_PATR_Service;
        private readonly IInstituteService _instituteService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public Form1099_PATR_Controller(IForm1099_PATR_Service Form1099_PATR_Service, IWebHostEnvironment webHostEnvironment, IInstituteService instituteService)
        {
        ...
        public IActionResult Index()
        {
            ...
            return View(_form1099_PATR_Service.GetForm1099List().Where(p => p.EntityId == EntityId && p.InstID == InstId));
        }
        [Route("Form1099_PATR_/uploadClients")]
        [HttpPost]
        public async Task<IActionResult> UploadClients(IFormFile file, int EntityId, string entityName)
        {
            ...
            var response = await _form1099_PATR_Service.Upload1099_Data(file, EntityId, SessionUser.InstituteId, SessionUser.UserId);
        ...
        [HttpPost]
        [Route("Form1099_PATR_/DownloadAll")]
        ...
        [HttpPost]
        [Route("Form1099_PATR_/DownloadOneFile")]
        public IActionResult DownloadOneFile([FromBody] DownloadRequestModel model)
        {
            ...
            //    selectedPage.Add("7");
            //}
            var zipFilePath = _form1099_PATR_Service.DownloadOneFile(ids, SavePathFolder, selectedPage, RootPath);
            string contentType = "application/zip";
        ...
        [Route("Form1099_PATR_/KeepRecord")]
        [HttpPost]
        public async Task<IActionResult> KeepRecord(int id)
        {
            ...
            var response = await _form1099_PATR_Service.KeepRecord(id);
            return Json(response);
        }

        [Route("Form1099_PATR_/DeleteRecord")]
        [HttpPost]
        public async Task<IActionResult> DeleteRecord(int id)
        {
            ...
            var response = await _form1099_PATR_Service.DeletePermeant(id);
            return Json(response);
        }
    }
}
