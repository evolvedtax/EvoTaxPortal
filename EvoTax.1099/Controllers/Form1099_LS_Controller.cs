...
{
    public class Form1099_LS_Controller : BaseController
    {
        private readonly IForm1099_LS_Service _form1099_LS_Service;
        private readonly IInstituteService _instituteService;
        private readonly ICommonService _commonService;
        private readonly IWebHostEnvironment _webHostEnvironment;
        public Form1099_LS_Controller(IForm1099_LS_Service form1099_LS_Service, IWebHostEnvironment webHostEnvironment, ICommonService commonService, IInstituteService instituteService)
        {
        ...
        public IActionResult Index()
        {
            ...
            return View(_form1099_LS_Service.GetForm1099LSList().Where(p => p.EntityId == EntityId));
        }
        [Route("Form1099_LS_/uploadClients")]
        [HttpPost]
        public async Task<IActionResult> UploadClients(IFormFile file, int EntityId, string entityName)
        {
            ...
            var response = await _form1099_LS_Service.Upload1099_LS_Data(file, SessionUser.InstituteId, EntityId, SessionUser.UserId);
        ...
        public IActionResult ChangeEntity(int entityId)
        {
            ...
            //var response = _form1099_LS_Service.GetForm1099LSList().Where(p => p.EntityId == entityId);
            //return RedirectToAction("Index");
            return Json(new { Data = "true" });
        }
        #region PDF Creation Methods
        [Route("Form1099_LS_/downlodPdf")]
        [HttpGet]
        public IActionResult DownlodPdf(int Id)
        {

            string TemplatePathFile = Path.Combine(_webHostEnvironment.WebRootPath, "Forms", AppConstants.Form1099LSTemplateFileName);
            string SavePathFolder = Path.Combine(_webHostEnvironment.WebRootPath, AppConstants.Form1099LS);
            string pdfUrl = _form1099_LS_Service.GeneratePdf(Id, TemplatePathFile, SavePathFolder);
            return Json(pdfUrl);
        ...
        [Route("Form1099_LS_/DownloadAll")]
        public IActionResult DownloadAll([FromBody] DownloadRequestModel model)
        {
            ...
            string SavePathFolder = Path.Combine(_webHostEnvironment.WebRootPath, AppConstants.Form1099LS);
            var zipFilePath = _form1099_LS_Service.GenerateAndZipPdfs(ids, SavePathFolder, selectedPage, RootPath);
        ...
        [HttpPost]
        [Route("Form1099_LS_/DownloadOneFile")]
        public IActionResult DownloadOneFile([FromBody] DownloadRequestModel model)
        {
            ...
            //    selectedPage.Add("7");
            //}
            var zipFilePath = _form1099_LS_Service.DownloadOneFile(ids, SavePathFolder, selectedPage, RootPath);
            string contentType = "application/zip";
        ...
        public async Task<IActionResult> KeepRecord(int id)
        {
            ...
            var response = await _form1099_LS_Service.KeepRecord(id);
            return Json(response);
        }

        [Route("Form1099_LS_/DeleteRecord")]
        [HttpPost]
        public async Task<IActionResult> DeleteRecord(int id)
        {
            ...
            var response = await _form1099_LS_Service.DeletePermeant(id);
            return Json(response);
        }
    }
