...
{
    public interface IForm1098_Service
    {
        IQueryable<Form1098Response> GetForm1098List();
        Task<MessageResponseModel> Upload1098_Data(IFormFile file, int InstId,int entityId, string UserId);
