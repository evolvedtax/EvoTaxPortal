...
{
    public interface IForm1098_F_Service
    {
        IQueryable<Form1098FResponse> GetForm1098FList();
        Task<MessageResponseModel> Upload1098_F_Data(IFormFile file, int InstId,int entityId, string UserId);
