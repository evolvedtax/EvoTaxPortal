...
{
    public interface IForm1098_Q_Service
    {
        IQueryable<Form1098QResponse> GetForm1098QList();
        Task<MessageResponseModel> Upload1098_Q_Data(IFormFile file, int InstId,int entityId, string UserId);
