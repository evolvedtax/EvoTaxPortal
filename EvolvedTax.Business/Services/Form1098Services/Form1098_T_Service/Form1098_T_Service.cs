...
{
    public class Form1098_T_Service : IForm1098_T_Service
    {
        ...
        public Form1098_T_Service(EvolvedtaxContext evolvedtaxContext, IMapper mapper, IInstituteService instituteService, IMailService mailService = null, ITrailAudit1099Service trailAudit1099Service = null)
        {
        ...
        public IQueryable<Form1098TResponse> GetForm1098TList()
        {
            var response = _evolvedtaxContext.Tbl_1098_T.Select(p => new Form1098TResponse
            {
                Id = p.Id,
                RcpTIN = p.RcpTIN,
        ...
        public string CreatePdf(int Id, string TemplatefilePath, string SaveFolderPath, int entityId, bool IsAll, string Page = "")
        {
            ...
            {
                newFile1 = string.Concat(ClientName, "_", AppConstants.Form1098T, "_", response.Id, "_Page_", Page);
            }
            else
            {
                newFile1 = string.Concat(ClientName, "_", AppConstants.Form1098T, "_", response.Id);
            }
        ...
        public string GeneratePdfForSpecificPage(int Id, string TemplatefilePath, string SaveFolderPath, List<string> selectedPages, int entityId)
        {
            ...
            newFile1 = string.Concat(ClientName, "_", AppConstants.Form1098T, "_", Id);
            string FilenameNew = "/Form1098T/" + newFile1 + ".pdf";
        ...
        public string GeneratePdForSpecificType(int Id, string TemplatefilePath, string SaveFolderPath, string selectedPage, int entityId = 0)
        {
            ...
            newFile1 = string.Concat(ClientName, "_", AppConstants.Form1098T, "_", request.Id, "_Page_", selectedPage);
            string FilenameNew = "/Form1098T/" + newFile1 + ".pdf";
            string newFileName = newFile1 + ".pdf";
        ...
        public string DownloadOneFile(List<int> ids, string SaveFolderPath, List<string> selectedPages, string RootPath, int entityId = 0)
        {
            ...
            string TemplatePathFile = Path.Combine(RootPath, "Forms", AppConstants.Form1098TTemplateFileName);
