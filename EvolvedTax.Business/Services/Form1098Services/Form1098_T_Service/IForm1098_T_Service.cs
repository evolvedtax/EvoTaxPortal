...
{
    public interface IForm1098_T_Service
    {
        IQueryable<Form1098TResponse> GetForm1098TList();
        Task<MessageResponseModel> Upload1098_T_Data(IFormFile file, int InstId,int entityId, string UserId);
