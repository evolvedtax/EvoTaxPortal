...
{
    public class Form5498_SA_Service : IForm5498_SA_Service
    {
        ...
        public Form5498_SA_Service(EvolvedtaxContext evolvedtaxContext, IMapper mapper, IInstituteService instituteService, IMailService mailService = null, ITrailAudit1099Service trailAudit1099Service = null)
        {
        ...
        public IQueryable<Form5498SAResponse> GetForm5498SASList()
        {
            var response = _evolvedtaxContext.Tbl_5498_SA.Select(p => new Form5498SAResponse
            {
                Id = p.Id,
                RcpTIN = p.RcpTIN,
                ...
                Box6Checkbox1 = p.Box6Checkbox1,
                Box6Checkbox2 = p.Box6Checkbox2,
                Box6Checkbox3 = p.Box6Checkbox3,
        ...
        public async Task<MessageResponseModel> Upload5498_SA_Data(IFormFile file, int InstId, int entityId, string UserId)
        {
            bool Status = false;
            ...
            using (var stream = file.OpenReadStream())
            {
                ...
                for (int row = 1; row <= sheet.LastRowNum; row++) // Starting from the second row
                {
                    ...
                    if (await _evolvedtaxContext.Tbl_5498_SA.AnyAsync(p => p.RcpTIN == request.RcpTIN && p.EntityId == request.EntityId && p.Created_Date != null &&
        ...
        public string CreatePdf(int Id, string TemplatefilePath, string SaveFolderPath, int entityId, bool IsAll, string Page = "")
        {
            ...
            {
                newFile1 = string.Concat(ClientName, "_", AppConstants.Form5498SA, "_", response.Id, "_Page_", Page);
            }
            else
            {
                newFile1 = string.Concat(ClientName, "_", AppConstants.Form5498SA, "_", response.Id);
            }


            string FilenameNew = "/Form5498SA/" + newFile1 + ".pdf";
        ...
        public string GeneratePdfForSpecificPage(int Id, string TemplatefilePath, string SaveFolderPath, List<string> selectedPages, int entityId)
        {
            ...
            newFile1 = string.Concat(ClientName, "_", AppConstants.Form5498SA, "_", Id);
            string FilenameNew = "/Form5498SA/" + newFile1 + ".pdf";
        ...
        public string GeneratePdForSpecificType(int Id, string TemplatefilePath, string SaveFolderPath, string selectedPage, int entityId = 0)
        {
            ...
            newFile1 = string.Concat(ClientName, "_", AppConstants.Form5498SA, "_", request.Id, "_Page_", selectedPage);
            string FilenameNew = "/Form5498SA/" + newFile1 + ".pdf";
            string newFileName = newFile1 + ".pdf";
        ...
        public string DownloadOneFile(List<int> ids, string SaveFolderPath, List<string> selectedPages, string RootPath, int entityId = 0)
        {
            ...
            string TemplatePathFile = Path.Combine(RootPath, "Forms", AppConstants.Form5498SATemplateFileName);
