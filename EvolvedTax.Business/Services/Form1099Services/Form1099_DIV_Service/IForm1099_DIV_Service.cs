...
{
    public interface IForm1099_DIV_Service
    {
        IQueryable<Form1099DIVResponse> GetForm1099DIVList();
        Task<MessageResponseModel> Upload1099_DIV_Data(IFormFile file, int InstId,int entityId, string UserId);
       // string GeneratePdf(int id, string BasePath);
        ...
        Task<bool> SendEmailToRecipients(int[] selectValues, string URL, string form1099DIV, int instituteId = -1);
