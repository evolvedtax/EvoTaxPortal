        ...
        public async Task<MessageResponseModel> Upload1099_Data(IFormFile file, int entityId, int InstId, string UserId)
        {
            ...
            using (var stream = file.OpenReadStream())
            {
                ...
                for (int row = 1; row <= sheet.LastRowNum; row++) // Starting from the second row
                {
                    ...
                    string cell_value_17 = excelRow.GetCell(columnMapping["Box 5 Checkbox"])?.ToString();
                    ...
                    var entity = new Tbl1099_C
                    {
                        ...
                        Box_4_All_Lines = excelRow.GetCell(columnMapping["Box 4 All Lines"])?.ToString(),
                        Box_5_Checkbox = Box_5_Checkbox,
                        Box_6_Code = excelRow.GetCell(columnMapping["Box 6 Code"])?.ToString(),
