...
{
    public class Form1099_C_Service : IForm1099_C_Service
    {
        ...
        {
            bool Status = false;
            var response = new List<Tbl1099_C>();
            var List = new List<Tbl1099_C>();
            using (var stream = file.OpenReadStream())
            {
                ...
                for (int row = 1; row <= sheet.LastRowNum; row++) // Starting from the second row
                {
                    ...
                    string Box_5_Checkbox = string.IsNullOrEmpty(cell_value_17) ? "0" : (cell_value_17.Equals("Yes", StringComparison.OrdinalIgnoreCase) ? "1" : "0");
                    ...
                    var entity = new Tbl1099_C
                    {
                        ...
                        Box_1_Date =  !string.IsNullOrWhiteSpace(excelRow.GetCell(13)?.ToString()) ? (DateTime?)Convert.ToDateTime(excelRow.GetCell(13)?.ToString()) : null,
                        Box_2_Amount = TryConvertToDecimal(excelRow.GetCell(14)),
                        Box_3_Amount = TryConvertToDecimal(excelRow.GetCell(15)),
                        Box_4_All_Lines = excelRow.GetCell(16)?.ToString(),
                        Box_5_Checkbox = Box_5_Checkbox,
                        Box_6_Code = excelRow.GetCell(18)?.ToString(),
                        Box_7_Amount = TryConvertToDecimal(excelRow.GetCell(19)),
                    ...
                    if (await _evolvedtaxContext.Tbl1099_C.AnyAsync(p => 
            ...
            p.Created_Date.Value.Year == DateTime.Now.Year))
                    ...
                    await _evolvedtaxContext.Tbl1099_C.AddRangeAsync(List);
        ...
        public string CreatePdf(int Id, string TemplatefilePath, string SaveFolderPath, bool IsAll, string Page = "")
        {
            ...
            {
                newFile1 = string.Concat(ClientName, "_", AppConstants.C1099Form, "_", request.Id, "_Page_", Page);
            }
            else
            {
                newFile1 = string.Concat(ClientName, "_", AppConstants.C1099Form, "_", request.Id);
            }


            string FilenameNew = "/1099C/" + newFile1 + ".pdf";
            ...
            pdfFormFields.SetField("topmostSubform.CopyA.FormHeader.CalendarYear.f1_1", currentYear);   //23
            ...
            if (!string.IsNullOrEmpty(request.Box_1_Date?.ToString()))
            {
                ...
                {
                    pdfFormFields.SetField("topmostSubform.CopyA.RightCol.f1_9", Box_1_Date.ToString("MM/dd/yyyy"));
                }

            }
            pdfFormFields.SetField("topmostSubform.CopyA.RightCol.f1_10", request.Box_2_Amount.HasValue ? request.Box_2_Amount.Value.ToString() : string.Empty);   //PageA1
            pdfFormFields.SetField("topmostSubform.CopyA.RightCol.f1_11", request.Box_3_Amount.HasValue ? request.Box_3_Amount.Value.ToString() : string.Empty);   //PageA2
            
            pdfFormFields.SetField("topmostSubform.CopyA.RightCol.f1_12", request.Box_4_All_Lines);   //Box_4_All_Lines
            if (request.Box_5_Checkbox != "1")
            {
                pdfFormFields.SetField("topmostSubform.CopyA.RightCol.c1_2", "1");   //PageAFATCA

            }
            pdfFormFields.SetField("topmostSubform.CopyA.RightCol.f1_13", request.Box_6_Code);   //Box_6_Code
            pdfFormFields.SetField("topmostSubform.CopyA.RightCol.f1_14", request.Box_7_Amount.HasValue ? request.Box_7_Amount.Value.ToString() : string.Empty);  //PageA4

            #endregion

            #region Page 2
            pdfFormFields.SetField("topmostSubform.CopyB.FormHeader.CalendarYear.f2_1", currentYear);   //23
            ...
            if (!string.IsNullOrEmpty(request.Box_1_Date?.ToString()))
            {
                ...
                if (DateTime.TryParse(request.Box_1_Date?.ToString(), out Box_1_Date))
                {
                    pdfFormFields.SetField("topmostSubform.CopyB.RightCol.f2_9", Box_1_Date.ToString("MM/dd/yyyy"));
                }

            }
            pdfFormFields.SetField("topmostSubform.CopyB.RightCol.f2_10", request.Box_2_Amount.HasValue ? request.Box_2_Amount.Value.ToString() : string.Empty);   //PageA1
            pdfFormFields.SetField("topmostSubform.CopyB.RightCol.f2_11", request.Box_3_Amount.HasValue ? request.Box_3_Amount.Value.ToString() : string.Empty);   //PageA2
            
            pdfFormFields.SetField("topmostSubform.CopyB.RightCol.f2_12", request.Box_4_All_Lines);   //Box_4_All_Lines
            if (request.Box_5_Checkbox != "1")
            {
                pdfFormFields.SetField("topmostSubform.CopyB.RightCol.c2_2", "1");   //PageAFATCA

            }
            pdfFormFields.SetField("topmostSubform.CopyB.RightCol.f2_13", request.Box_6_Code);   //Box_6_Code
            pdfFormFields.SetField("topmostSubform.CopyB.RightCol.f2_14", request.Box_7_Amount.HasValue ? request.Box_7_Amount.Value.ToString() : string.Empty);  //PageA4

            #endregion

            #region Page 3
            pdfFormFields.SetField("topmostSubform.CopyC.FormHeader.CalendarYear.f2_1", currentYear);   //23
            pdfFormFields.SetField("topmostSubform.CopyA.FormHeader.CalendarYear.f1_1", currentYear);   //23
            if (request.Corrected.ToString() == "1")
            {
            ...
            if (!string.IsNullOrEmpty(request.Box_1_Date?.ToString()))
            {
                ...
                if (DateTime.TryParse(request.Box_1_Date?.ToString(), out Box_1_Date))
                {
                    pdfFormFields.SetField("topmostSubform.CopyC.RightCol.f2_9", Box_1_Date.ToString("MM/dd/yyyy"));
                }

            }
            pdfFormFields.SetField("topmostSubform.CopyC.RightCol.f2_10", request.Box_2_Amount.HasValue ? request.Box_2_Amount.Value.ToString() : string.Empty);   //PageA1
            pdfFormFields.SetField("topmostSubform.CopyC.RightCol.f2_11", request.Box_3_Amount.HasValue ? request.Box_3_Amount.Value.ToString() : string.Empty);   //PageA2
            
            pdfFormFields.SetField("topmostSubform.CopyC.RightCol.f2_12", request.Box_4_All_Lines);   //Box_4_All_Lines
            if (request.Box_5_Checkbox != "1")
            {
                pdfFormFields.SetField("topmostSubform.CopyC.RightCol.c2_2", "1");   //PageAFATCA

            }
            pdfFormFields.SetField("topmostSubform.CopyC.RightCol.f2_13", request.Box_6_Code);   //Box_6_Code
            pdfFormFields.SetField("topmostSubform.CopyC.RightCol.f2_14", request.Box_7_Amount.HasValue ? request.Box_7_Amount.Value.ToString() : string.Empty);  //PageA4
        ...
        public string GenerateAndZipPdfs(List<int> ids, string SaveFolderPath, List<string> selectedPages, string RootPath)
        {
            ...
            foreach (var id in ids)
            {
                ...
                string TemplatePathFile = Path.Combine(RootPath, "Forms", AppConstants.C_1099_TemplateFileName);
        ...
        public string GeneratePdfForSpecificPage(int Id, string TemplatefilePath, string SaveFolderPath, List<string> selectedPages)
        {
            ...
            var request = _evolvedtaxContext.Tbl1099_C.FirstOrDefault(p => p.Id == Id);
            String ClientName = request.First_Name + " " + request.Name_Line_2?.Replace(": ", "");
            newFile1 = string.Concat(ClientName, "_", AppConstants.C1099Form, "_", Id);
            string FilenameNew = "/1099C/" + newFile1 + ".pdf";
        ...
        public string GeneratePdForSpecificType(int Id, string TemplatefilePath, string SaveFolderPath, string selectedPage)
        {
            ...
            newFile1 = string.Concat(ClientName, "_", AppConstants.C1099Form, "_", request.Id, "_Page_", selectedPage);
            string FilenameNew = "/1099C/" + newFile1 + ".pdf";
            string newFileName = newFile1 + ".pdf";
                ...
                foreach (var selectedPage in selectedPages)
                {
                    ...
                    switch (selectedPage)
                    {
                        case "2":
                            ...
                            break;
                        case "3":
                            compileFileName = "For Debtor.pdf";
                            break;
                        case "5":
                            compileFileName = "For Creditor.pdf";
                            break;
                        default:
        ...
        public async Task<MessageResponseModel> DeletePermeant(int id)
        {
            ...
            var recordToDelete = _evolvedtaxContext.Tbl1099_C.First(p => p.Id == id);
            if (recordToDelete != null)
            {
                _evolvedtaxContext.Tbl1099_C.Remove(recordToDelete);
                await _evolvedtaxContext.SaveChangesAsync();
        ...
        public async Task<MessageResponseModel> KeepRecord(int id)
        {
            ...
            var recordToUpdate = _evolvedtaxContext.Tbl1099_C.First(p => p.Id == id);
        ...
        {
            var result = from ic in _evolvedtaxContext.Tbl1099_C
                         where selectValues.Contains(ic.Id) && !string.IsNullOrEmpty(ic.Rcp_Email)
                         select new Tbl1099_C
                         {
        ...
        public IEnumerable<Tbl1099_C> GetForm1099List()
        {
            return _evolvedtaxContext.Tbl1099_C.AsEnumerable();
        }
