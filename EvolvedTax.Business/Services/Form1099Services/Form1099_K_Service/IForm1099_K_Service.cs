...
{
    public interface IForm1099_K_Service
    {
        IQueryable<Form1099KResponse> GetForm1099KList();
        Task<MessageResponseModel> Upload1099_K_Data(IFormFile file, int InstId,int entityId, string UserId);
       // string GeneratePdf(int id, string BasePath);
        ...
        Task<bool> SendEmailToRecipients(int[] selectValues, string URL, string form1099K, int instituteId = -1);
