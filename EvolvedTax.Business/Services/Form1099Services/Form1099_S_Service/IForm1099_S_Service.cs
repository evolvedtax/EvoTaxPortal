...
{
    public interface IForm1099_S_Service
    {
        IQueryable<Form1099SResponse> GetForm1099SList();
        Task<MessageResponseModel> Upload1099_S_Data(IFormFile file, int InstId,int entityId, string UserId);
       // string GeneratePdf(int id, string BasePath);
        ...
        Task<bool> SendEmailToRecipients(int[] selectValues, string URL, string form1099S, int instituteId = -1);
