...
{
    public interface IForm1099_OID_Service
    {
        IQueryable<Form1099OIDResponse> GetForm1099OIDList();
        Task<MessageResponseModel> Upload1099_OID_Data(IFormFile file, int InstId,int entityId, string UserId);
       // string GeneratePdf(int id, string BasePath);
        ...
        Task<bool> SendEmailToRecipients(int[] selectValues, string URL, string form1099OID, int instituteId = -1);
