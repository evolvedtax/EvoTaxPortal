...
{
    public interface IForm1099_Q_Service
    {
        IQueryable<Form1099QResponse> GetForm1099QList();
        Task<MessageResponseModel> Upload1099_Q_Data(IFormFile file, int InstId,int entityId, string UserId);
       // string GeneratePdf(int id, string BasePath);
        ...
        Task<bool> SendEmailToRecipients(int[] selectValues, string URL, string form1099Q, int instituteId = -1);
