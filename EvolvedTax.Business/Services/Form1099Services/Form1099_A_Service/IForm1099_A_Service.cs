...
{
    public interface IForm1099_A_Service
    {
        IQueryable<Form1099AResponse> GetForm1099AList();
        Task<MessageResponseModel> Upload1099_A_Data(IFormFile file, int InstId,int entityId, string UserId);
       // string GeneratePdf(int id, string BasePath);
        ...
        Task<bool> SendEmailToRecipients(int[] selectValues, string URL, string form1099A, int instituteId = -1);
