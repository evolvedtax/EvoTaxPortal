        ...
        protected static string W9Creation(FormRequest request)
        {
            ...
            try
            {
                ...
                if (request.IndividualOrEntityStatus == AppConstants.IndividualStatus)
                {
                    ...
                    pdfFormFields.SetField("topmostSubform[0].Page1[0].f1_01[0]", string.Concat(request.GQFirstName, " ", request.GQLastName));
                    // Social security number
                    if (!string.IsNullOrEmpty(request.Ssnitnein))
                    {
                        pdfFormFields.SetField("topmostSubform[0].Page1[0].f1_11[0]", request?.Ssnitnein?.Substring(0, 3));
                        pdfFormFields.SetField("ttopmostSubform[0].Page1[0].f1_12[0]", request?.Ssnitnein?.Substring(4, 2));
                        pdfFormFields.SetField("topmostSubform[0].Page1[0].f1_13[0]", request?.Ssnitnein?.Substring(7, 4));
                ...
                else
                {
                    ...
                    pdfFormFields.SetField("topmostSubform[0].Page1[0].f1_15[0]", request?.Ssnitnein?.Substring(3, 7));
                    // Exempt payee code (if any)
                    pdfFormFields.SetField("topmostSubform[0].Page1[0].f1_05[0]", request?.Payeecode);
                    // Exemption From FATCA reporting code(If any)
                    pdfFormFields.SetField("topmostSubform[0].Page1[0].f1_06[0]", request.W9Fatca);
                ...
                iTextSharp.text.Rectangle rectangle = new iTextSharp.text.Rectangle(130, 195, 350, 250, 0);
                ...
                iTextSharp.text.Rectangle rectangle1 = new iTextSharp.text.Rectangle(440, 195, 510, 250, 0);
