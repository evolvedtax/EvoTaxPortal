...
namespace EvolvedTax.Data.Models.Entities._1099
{
    public partial class Tbl1099_MISC
    {
        ...
        public decimal? Box_15_Amount { get; set; }

        public decimal? Box_16_Amount { get; set; }

        public string? Box_17_State { get; set; }

        public string? Box_17_ID_Number { get; set; }

        public decimal? Box_18_Amount { get; set; }

        public string? Opt_Rcp_Text_Line_1 { get; set; }

        public string? Opt_Rcp_Text_Line_2 { get; set; }
