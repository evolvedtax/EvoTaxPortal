...
{
    public partial class Tbl1099_DIV
    {
        [Key]
        ...
        public decimal? Box_2b_Amount { get; set; }

        public decimal? Box_2c_Amount { get; set; }

        public decimal? Box_2d_Amount { get; set; }

        public decimal? Box_2e_Amount { get; set; }

        public decimal? Box_2f_Amount { get; set; }
        ...
        public string? Box_8_Foreign { get; set; }
