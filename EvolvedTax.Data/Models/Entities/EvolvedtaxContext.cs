...
public partial class EvolvedtaxContext : IdentityDbContext<User>
{
    ...
    public virtual DbSet<EntityFormAccess> EntityFormAccess { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InstitutesClient>(entity =>
        {
            ...
            entity.Property(e => e.IsDuplicated).HasDefaultValueSql("((0))");
            entity.Property(e => e.LastUpdatedOn).HasColumnType("datetime");
            entity.Property(e => e.Otp)
                .HasMaxLength(50)
                .IsUnicode(false)
