...
public class Tbl_1098
{
    ...
    public DateTime? Box3DATETIME { get; set; }
    ...
    public string? Box8AllLines { get; set; }

    public int? Box9Number { get; set; }

    public string? Box10AllLines { get; set; }

    public DateTime? Box11DATETIME { get; set; }
